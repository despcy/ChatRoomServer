...
int main(){
    Database database;
    cout<<database.isFriend("haha", "test");
    database.createUser("chenxi", "123321");
    database.createUser("chenxi2", "123321");
   // database.delFriend("test", "haha");
    vector<string> a=database.getAllFriends("haha");
    cout<<a[0];
    return 0;
}
